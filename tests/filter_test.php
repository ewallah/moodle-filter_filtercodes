...
class filter_filtercodes_testcase extends advanced_testcase {
    ...
    public function test_filter_filtercodes() {
        ...
        $user = $this->getDataGenerator()->create_user(['country' => 'BE']);
        $this->setUser($user);
        ...
        $tests = array(
            ...
            array (
                'before' => '{langx}Bad filter syntax{langx}{langx es}Algo en español{/langx}',
            ...
            array (
                ...
                'after'  => 'Before {langx non-existent-language}Some content{/langx} After',
            ),
            array (
                'before' => 'Before {langx en}Some content{/langx} After',
                'after'  => 'Before <span lang="en">Some content</span> After',
            ),
            array (
                'before' => 'Before {langx en-ca}Some content{/langx} After',
                'after'  => 'Before {langx en-ca}Some content{/langx} After',
            ),
            array (
